// Trilha "Tráfego pago" do curso "Zumbido na Prática".
// Para adicionar/editar uma aula, mexa só aqui — não precisa tocar em componentes React.
//
// nonTechLesson(numero, titulo, pontos) -> divider -> agenda -> (point -> agenda) x N
//   pontos: [{ title, text }]
// techLesson(numero, titulo, blocos) -> divider -> agenda -> tecnica (1 slide por bloco)
//   blocos: [{ title, steps: [...], shotBox?: false, note? }]
//   bloco sem passos técnicos, só uma fala: { type: 'point', title, text }
...
export const lessons = [
  ...
  nonTechLesson(2, 'Orgânico x Pago', [
    {
  ...
  nonTechLesson(3, 'Alinhando expectativas', [
    {
  ...
  techLesson(4, 'Criando a estrutura completa', [
    {
  ...
  techLesson(5, 'Primeira campanha: Impulsionar', [
    {
  ...
  techLesson(6, 'Primeira campanha de Mensagens (WhatsApp)', [
    {
  ...
  techLesson(8, 'Métricas e organização da BM', [
    {
  ...
  techLesson(9, 'WhatsApp Business + importância do CRM', [
    {
  ...
  nonTechLesson(10, 'Considerações finais', [
    {
      title: 'Recapitulando',
...
export default {
  label: 'Tráfego pago para profissionais de zumbido',
  cover,
  lessons,
}
